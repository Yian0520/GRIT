function [scdata,Tgrid,GT] = proteinData(simOpts,Tgrid)
...
%Get the ground truth and mean for the initial distribution
[~,~,GT,x0,x1] = getLinSystem(simOpts.seed,false);

%Parameters for the protein dynamics
rng(simOpts.seed)
d = .5 + .5*rand(10,1);
