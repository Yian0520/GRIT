...
%Gene 1
dx(1,1) = a1*x(1);
dx(1,2) = (k1*(x(7)+x(10)) + v1)/(1+c1*(x(7)+x(10)));

%Gene 2
dx(2,1) = a2*x(2);
dx(2,2) = (k2*x(1) + v2)/(1 + c2*x(1))/(1+d2*x(3));

%Gene 3
dx(3,1) = a3*x(3);
dx(3,2) = (k3*x(2) + v3)/(1+c3*x(2));

%Gene 4
dx(4,1) = a4*x(4);
dx(4,2) = (k4*x(3) + v4)/(1+c4*x(3));

%Gene 5
dx(5,1) = a5*x(5);
dx(5,2) = (k5*x(4) + v5)/(1+c5*x(4));

%Gene 6
dx(6,1) = a6*x(6);
dx(6,2) = (k6*(x(3)+x(5)) + v6)/(1+c6*(x(3)+x(5)));

%Gene 7
dx(7,1) = a7*x(7);
dx(7,2) = (k7*x(6) + v7)/(1 + c7*x(6))/(1+d7*x(9));

%Gene 8
dx(8,1) = a8*x(8);
dx(8,2) = (k8*x(7) + v8)/(1+c8*x(7));

%Gene 9
dx(9,1) = a9*x(9);
dx(9,2) = (k9*x(8) + v9)/(1+c9*x(8));

%Gene 10
dx(10,1) = a10*x(10);
dx(10,2) = (k10*x(9) + v10)/(1+c10*x(9));
